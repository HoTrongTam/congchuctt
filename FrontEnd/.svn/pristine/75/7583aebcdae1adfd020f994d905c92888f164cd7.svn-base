...
function mainFtr(
    ...
    self.getMenu = function(user) {
        ...
        menus = [
			{ id: 0, active: 1, icon: 'ion-home', name: 'Trang chủ', selected: false, route: 'app.home', cssStyle:'item' },
			{ id: 1, active: 1, icon: 'icon-mydoc', name: 'Hồ sơ của tôi ', selected: false, route: 'app.document-list', cssStyle:'item' },
			{ id: 2, active: 1, icon: 'icon-listprod', name: 'Thủ tục hành chính', selected: false, route: 'app.procedure-list', cssStyle:'item' },
			// { id: 8, active: 1, icon: 'ion-stats-bars', name: 'Tình hình xử lý hồ sơ', selected: false, route: 'app.tinh-hinh-xu-ly-hs', cssStyle:'item' },
			// { id: 9, active: 1, icon: 'ion-android-globe', name: 'Thống kê HS nộp qua mạng', selected: false, route: 'app.thong-ke-hs', cssStyle:'item' },
      // { id: 12, active: 1, icon: 'ion-android-calendar', name: 'Lịch lãnh đạo', selected: false, route: 'app.tra-cuu-lich-lanh-dao', cssStyle:'item' },
      		{ id: 10, active: 1, icon: 'ion-android-chat', name: 'Hỏi đáp', selected: false, route: 'app.hoidap-list', cssStyle:'item' },
        	{ id: 3, active: 1, icon: 'icon-null', name: 'Hệ thống', selected: false, route: '', cssStyle:'item style-2'},
			{ id: 4, active: 1, icon: 'icon-about', name: 'Ứng dụng Dịch Vụ Công', selected: false, route: 'app.about', cssStyle:'item style-1' },
			{ id: 5, active: 1, icon: 'icon-changepass', name: 'Đổi mật khẩu', selected: false, route: 'app.change-user-profile', cssStyle:'item style-1' },
			{ id: 11, active: 1, icon: 'ion-ios-help-outline', name: 'Hướng dẫn sử dụng', selected: false, route: 'app.huong-dan-su-dung', cssStyle:'item style-1' },
      { id: 6, active: 1, icon: 'icon-logout', name: 'Đăng xuất', selected: false, route: null, cssStyle:'item style-1' },
			{ id: 7, active: 1, icon: 'icon-exit', name: 'Thoát ứng dụng', selected: false, route: null, cssStyle:'item style-1' }
		];
