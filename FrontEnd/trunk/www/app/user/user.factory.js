...
(function() {
  ...
  function userFtr(
      ...
      sco.signin = function() {
        ...
        self.logIn(sco.user_form).then(
          function(rep) {
            ...
            self
              .getInfo({
                object: user.nguoidangkyid
              })
              .then(
                function(repinfo) {
                  console.log(repinfo);
                  fpt_notification.connection(
                    sco.workPlace.NotificationPushURL,
                    repinfo.nguoidangkyid.toString(),
                    CONST.APP_CODE,
                    "mobile"
                  );
          ...
          function(err) {
            if (err == "Người dùng chưa được kích hoạt") {
              Popup.c(
                "Tài khoản chưa kích hoạt, Bấm xác nhận để vào kích hoạt",
                function(ok) {
    ...
    self.getInfo = function(params) {
      ...
      API.call(API_CONST.user.getInfo, params).then(
        function(rep) {
          $rootScope.user = rep;
          deferred.resolve(rep);
        },
    ...
    self.doiMatKhau = function(params) {
      ...
      // }
      return API.call(API_CONST.user.doiMatKhau, params);
    };
