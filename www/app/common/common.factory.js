  ...
  function mainFtr(
    ...
    self.getMenu = function (user) {
      ...
      menus = [
        ...
        { id: 2, active: 1, icon: 'iconsprite2-xulycongviec', name: 'Xử lý công việc', selected: false, route: 'app.ds-xulycongviec', cssStyle: 'item' },
        { id: 8, active: 1, icon: 'iconsprite2-lichcongtac', name: 'Lịch công tác', selected: false, route: 'app.lichcongtaccanhan', cssStyle: 'item' },
        { id: 1, active: 1, icon: 'iconsprite2-thongke', name: 'Thống kê', selected: false, route: 'app.ds-thongke', cssStyle: 'item' },
        { id: 10, active: 1, icon: 'iconsprite2-giaoviec', name: 'Giao việc', selected: false, route: 'app.ds-giaoviec', cssStyle: 'item' },
        { id: 12, active: 1, icon: 'iconsprite2-email', name: 'Danh bạ', selected: false, route: 'app.danhba', cssStyle: 'item' },
        { id: 13, active: 1, icon: 'iconsprite2-tracuu', name: 'Email', selected: false, route: '', cssStyle: 'item' },
        { id: 14, active: 1, icon: 'iconsprite2-danhba', name: 'Tra cứu', selected: false, route: 'app.ds-tracuu', cssStyle: 'item' },
        { id: 15, active: 1, icon: 'iconsprite2-traodoi', name: 'Hướng dẫn sử dụng', selected: false, route: '', cssStyle: 'item' },
        { id: 3, active: 1, icon: 'icon-null', name: 'Hệ thống', selected: false, route: '', cssStyle: 'item style-2' },
        { id: 5, active: 1, icon: 'iconsprite2-thongtintaikhoan', name: 'Thông tin tài khoản', selected: false, route: 'app.user-profile', cssStyle: 'item style-1' },
        { id: 11, active: 1, icon: 'iconsprite2-thongtinungdung', name: 'Thông tin ứng dụng', selected: false, route: '', cssStyle: 'item style-1' },
        { id: 6, active: 1, icon: 'iconsprite2-caidat', name: 'Cài đặt', selected: false, route: '', cssStyle: 'item style-1' },
        { id: 4, active: 1, icon: 'iconsprite2-dangxuat', name: 'Đăng xuất', selected: false, route: '', cssStyle: 'item style-1' }
      ];
